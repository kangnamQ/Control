...
class Controller(object):
	def __init__(self):
		...
		self.car_pos = rospy.Subscriber('/udp', UDP, self.pure_callback)
	...
	def pure_callback(self, data):
		self.car_point = data
		self.car_point_x = self.car_point.pose.pose.position.x + 1.15
		self.car_point_y = self.car_point.pose.pose.position.y + 0
		self.car_point_z = self.car_point.pose.pose.position.z + 0.296
		"""
