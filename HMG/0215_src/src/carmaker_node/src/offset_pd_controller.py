...
class Offset_controller(object):
    ...
    def pid_control(self):
        ...
        # self.acc_cmd = self.p_control() + self.pi_control() + self.D  # PID controller
        self.acc_cmd = self.p_control() + self.D    # PD controller
        # self.acc_cmd = self.p_control()   # P controller
        return self.acc_cmd
