...
class State:
    ...
    def __init__(self, x=0.0, y=0.0, yaw=0.0, v=0.0):
        ...
        # self.rear_x = self.rear_x * 1000
        # self.rear_y = self.rear_y * 1000
        # self.front_x = self.front_x * 1000
        # self.front_y = self.front_y * 1000
    ...
    def calc_distance(self, point_x, point_y):
        ...
        # print("rear_x : ", self.rear_x)
        # print("rear_y : ", self.rear_y)
            ...
            while True:
                if state.turn == 1:
                    ...
                    if state.v > 49:
                        ...
                        try:
                            distance_next_index = state.calc_distance(self.cx[ind + 2],
                                                                     self.cy[ind + 2])
                            k = 0.3
                        except IndexError:
                            distance_next_index = state.calc_distance(self.cx[(len(self.cx)-1)],
...
def pure_pursuit_steer_control(state, trajectory, pind):
    ...
    # alpha = math.atan2(ty - (state.rear_y * 1000), tx - (state.rear_x * 1000)) - state.yaw
